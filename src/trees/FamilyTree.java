...
public class FamilyTree
{
	...
	private static class TreeNode {
        ...
        private String toStringWithIndent(String indent) {
            StringBuilder s = new StringBuilder(indent + name + "\n");
            indent += "  ";
	...
	private void addLine(String line) throws TreeException {
	    ...
	    if (colonIndex < 0)
	        throw new TreeException("Invalid input format: Missing colon");
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException {
	    ...
	    if (node1 == null)
	        throw new TreeException("Node '" + name1 + "' not found in the family tree");
	    TreeNode node2 = root.getNodeWithName(name2);
	    if (node2 == null)
	        throw new TreeException("Node '" + name2 + "' not found in the family tree");
